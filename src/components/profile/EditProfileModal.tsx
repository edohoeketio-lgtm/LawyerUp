            ...
            <div className="w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-200 max-h-[90vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <form id="edit-profile-form" onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Location */}
                        <div className="space-y-1">
                            <label className="text-xs font-bold text-gray-500">City, Country</label>
                            <div className="relative">
                                <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                                    <Image src="https://flagcdn.com/ng.svg" alt="NG" width={16} height={12} className="object-cover" />
                                </div>
                                <input
                                    type="text"
                                    value={formData.location}
                                    onChange={(e) => setFormData({ ...formData, location: e.target.value })}
                                    className="w-full rounded-lg border border-gray-200 pl-10 pr-10 py-2.5 text-sm font-medium text-black focus:border-[#004d45] focus:outline-none"
                                />
                                <Map className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="rounded-lg border border-gray-200 p-2">
                                ...
                                <div className="mt-2 flex items-center justify-between border-t border-gray-100 pt-2">
                                    <span className="text-sm font-medium text-black">{formData.languages.length} selected</span>
